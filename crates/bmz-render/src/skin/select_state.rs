...
pub(super) fn grade_diff_rank_target_grade(
    state: &SkinDrawState,
    has_nearest_f_diff_rank_destination: bool,
) -> Option<&'static str> {
...
pub(super) fn nearest_grade_diff_rank_op(grade: &str) -> Option<i32> {
    match grade {
        "MAX" => Some(300),
        "AAA" => Some(301),
        "AA" => Some(302),
...
pub(super) fn nearest_grade_diff_rank_destination_grade(id: &str) -> Option<&'static str> {
    match id {
        "RANK_s_MAX" => Some("MAX"),
        "RANK_s_AAA" => Some("AAA"),
        "RANK_s_AA" => Some("AA"),
...
pub(super) fn nearest_f_diff_rank_destination_available(
    destinations: &[&SkinDestinationDef],
) -> bool {
    destinations.iter().any(|destination| destination.id == "RANK_s_F")
}

pub(super) fn apply_nearest_f_diff_rank_fallback<'a>(
...
pub(super) fn nearest_grade_diff_for_destination(
    state: &SkinDrawState,
    has_nearest_f_diff_rank_destination: bool,
...
pub(super) fn nearest_e_minus_diff(state: &SkinDrawState) -> Option<NearestGradeDiff> {
